...
@Autonomous(name = "Roadster")
public class Roadster extends LinearOpMode
{
    ...
    private final double HIGH_JUNCTION = 33.18; // Length slides must move for highest junction
    ...
    public void runOpMode()
    {
        ...
        // This autonomous assumes the robot is on the right side
        xPos = 110.5; // inches from left wall to center point of claw ; was 101.35
        yPos = 2.5; // inches from back wall to center point of claw ; was 1.81
        ...
        goToY(77.65); // was 51.55
        forward(6);
        backward(6);
        goToX(93.18); // was 66.45
        scoreCone(4);
