...
public class Roadster extends LinearOpMode
{
    ...
    private final double HIGH_JUNCTION = 32.5; // Length slides must move for highest junction
    ...
    public void runOpMode()
    {
        ...
        xPos = 101.35; // inches from left wall to center point of claw
        ...
        goToY(55.65); // was 51.55
        forward(6);
        backward(6);
        goToX(60.45); // was 66.45
        scoreCone(4);
